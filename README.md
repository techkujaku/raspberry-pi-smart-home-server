...
5) Mounting USB and Using FTP with mobile devices
6) Qbittorent
7) Plex-Server
...
14) Broadlink intergration with home-assistant
15) Openvpn remote access to home assistant
16) pi-hole
17) mealie
18) Owncloud hosting
19) Webcam and home assistant
20) Minecraft server 
